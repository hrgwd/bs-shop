    ...
    <div style="width: 60%; margin: 30px auto; border-radius: 20px">
      <div style="height: 100px; padding: 0 10px; display: flex; align-items: center; border-radius: 25px; background-color: white;">
        ...
        <div style="width: 220px; margin: 0 30px 0 15px; font-size: 20px; font-weight: bold;">
          ...
          <img src="@/assets/imgs/icon.png" alt="" style="height: 45px; margin-top: 2px">
        </div>
        ...
        <div style="width: 150px; height: 100px; padding: 20px">
          ...
          <el-tooltip :content="businessData.email" placement="top" :disabled="!businessData.email">
            <div style="font-size: 16px; height: 30px; line-height: 30px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; cursor: pointer;">{{businessData.email}}</div>
          </el-tooltip>
        </div>
        <div style="flex: 1; height: 100px; padding: 20px">
          <el-tooltip :content="businessData.description" placement="top" :disabled="!businessData.description">
            <div style="height: 60px; line-height: 30px; font-size: 16px; color: #000000FF; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical; cursor: pointer;">
        ...
        <div style="margin-top: 20px">
          <el-row>
            <el-col :span="5" style="margin-bottom: 20px" v-for="item in goodsData" :key="item.id">
              <img :src="item.img" @click="navTo('/front/detail?id=' + item.id )" alt="" style="width: 100%; height: 150px; border-radius: 10px; border: #cccccc 1px solid">
