  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="description" label="商家简介" :show-overflow-tooltip="true"></el-table-column>
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.$confirm("您确定批量删除这些数据吗？", "确认删除", {
        ...
        .then((response) => {
          this.$request
            .delete("/business/delete/batch", { data: this.ids })
            .then((res) => {
              if (res.code === "200") {
                // 表示操作成功
                this.$message.success("操作成功");
